...
class UserSetting(models.Model):
    ...
    setting_id = models.ForeignKey(
        Setting, db_column="setting_id", related_name="setting_data")
...
class DisplayContactNameAs(models.Model):
    ...
    name_display_format = models.CharField(
        _("Name Display Format"), max_length=100)
    created_date = models.DateTimeField(
        _("Created Date"), auto_now_add=True, auto_now=False)
    updated_date = models.DateTimeField(
        _("Updated Date"), auto_now_add=False, auto_now=True)
