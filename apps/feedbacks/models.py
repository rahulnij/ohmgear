...
class FeedbackCategory(models.Model):
    ...
    category_name  = models.CharField(_("Category Name"),max_length=255,null=True)
    status         = models.IntegerField(_("Status"),default=1)
    created_date   = models.DateTimeField(_("Created Date"),auto_now_add=True,auto_now=False)
    updated_date   = models.DateTimeField(_("Update Date"),auto_now_add=False,auto_now=True)
...
class FeedbackCategorySubject(models.Model):
    ...
    feedback_category_id    =   models.ForeignKey(FeedbackCategory,db_column ="feedback_category_id")
...
class ContactUs(models.Model):
    ...
    user_id         =   models.ForeignKey(User,db_column='user_id')
    feedback_category_id  =  models.ForeignKey(FeedbackCategory,db_column="feedback_category_id")
    feedback_category_subject_id  =  models.ForeignKey(FeedbackCategorySubject,db_column="feedback_category_subject_id")
    description     =       models.TextField("Description")
    file_name      = models.FileField(_("File Name"),upload_to='uploads/contact_file/', max_length=254)
    created_date   = models.DateTimeField(_("Created Date"),auto_now_add=True,auto_now=False)
