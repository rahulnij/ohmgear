...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'account_number', 'email', 'email_verification_code',
                  'user_type', 'pin_number', 'status', 'password')
#        read_only_fields = ('id',)
...
class ConnectedAccountsSerializer(serializers.ModelSerializer):
    social_type = serializers.ReadOnlyField(
        source='social_type_id.social_type')
