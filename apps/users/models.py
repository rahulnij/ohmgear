...
class BusinessType(models.Model):
    ...
    business_type = models.CharField(
        _('Business Type'), max_length=50, null=True)
...
class IncomeGroup(models.Model):
    ...
    income_group = models.CharField(
        _('Income Group'), max_length=50, null=True)
...
class User(AbstractBaseUser):
    ...
    account_number = models.CharField(
        _("Account Number"), max_length=45, null=True)
...
#    last_name = models.CharField(_("Last Name"),max_length=45,null=True)
    ...
    email_verification_code = models.CharField(
        _("Email Verification"), max_length=45, null=True)
...
class SocialLogin(models.Model):
    ...
    social_media_login_id = models.CharField(
        _("Social Media Login Id"), null=True, max_length=50)
...
class ConnectedAccount(models.Model):
    ...
    social_type_id = models.ForeignKey(
        SocialType, db_column="social_type_id", related_name="social_type_id")
    created_date = models.DateTimeField(
        _("Created Date"), auto_now_add=True, auto_now=False)
    updated_date = models.DateTimeField(
        _("Updated Date"), auto_now_add=False, auto_now=True)
...
class UserEmail(models.Model):
    ...
    verification_code = models.CharField(
        _("Verification Code"), max_length=40, blank=True, null=True)
    created_date = models.DateTimeField(
        _("Created Date"), auto_now_add=True, auto_now=False)
