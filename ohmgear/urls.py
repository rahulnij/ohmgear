...
urlpatterns = patterns(
    ...
    url(r'^api/useractivity/$',
        'apps.users.views.useractivity',
        name='useractivity'),
    ...
    url(r'^api/account_confirmation/(?P<activation_key>\w+)/$',
        'apps.users.views.useractivity', name='registration_confirm'),
    url(r'^api/forgot_password/(?P<reset_password_key>\w+)/$',
        'apps.users.views.useractivity', name='forgot_password'),
...
router.register(
    r'api/feedbackcategory',
    feebackcategory_views.FeedbackCategoryViewSet)

import apps.feedbacks.views as feebackcategorysubject_views
router.register(r'api/feedbackcategorysubject',
                feebackcategorysubject_views.FeedbackCategorySubjectViewSet)
...
router.register(
    r'api/languagesetting',
    languagesetting_views.LanguageSettingViewSet)

import apps.usersetting.views as displaycontactsetting_views
router.register(r'api/displaycontactsetting',
                displaycontactsetting_views.DisplayContactNameAsViewSet)


#----------------Businesscard Vacation url ---------------------------#
import apps.vacationcard.views as businesscardvacation_views
router.register(r'api/businesscardvacation',
                businesscardvacation_views.BusinessCardVacationViewSet)
#-----------------End-------------------------------------------------#
...
router.register(r'api/cron/update_contact_link_status',
                cron_view.UpdateContactLinkStatusCron)
#_-------------------------------------------------------------------#
